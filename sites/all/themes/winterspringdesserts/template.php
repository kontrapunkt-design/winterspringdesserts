...
/*
function winterspringdesserts_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/
/*
function winterspringdesserts_preprocess_page(&$vars,$hook) {
  //typekit
...
*/
/*
function winterspringdesserts_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function winterspringdesserts_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function winterspringdesserts_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function winterspringdesserts_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function winterspringdesserts_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function winterspringdesserts_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/
/*
function winterspringdesserts_form_alter(&$form, &$form_state, $form_id) {
  //if ($form_id == '') {
  //....
  //}
}
*/
function winterspringdesserts_preprocess_page(&$variables) {
